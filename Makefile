...
SHARED_SRCS = utilities.cpp tuple.cpp canvas.cpp matrix.cpp sphere.cpp ray.cpp intersection.cpp light_source.cpp world.cpp camera.cpp shapes.cpp plane.cpp pattern.cpp computations.cpp cube.cpp cylinder.cpp cone.cpp groups.cpp bounding_box.cpp triangle.cpp obj_parser.cpp smooth_triangle.cpp

# Header files used to track dependencies
DEPS = material.h utilities.h tuple.h canvas.h matrix.h sphere.h ray.h intersection.h light_source.h color.h world.h camera.h shapes.h plane.h pattern.h computations.h cube.h cylinder.h cone.h groups.h bounding_box.h triangle.h obj_parser.h smooth_triangle.h
...
triangles: ch_15_triangles.cpp  $(SHARED_SRCS) $(DEPS)
	$(CXX) $(CXXFLAGS) ch_15_triangles.cpp $(SHARED_SRCS) -o ./bin/triangles
